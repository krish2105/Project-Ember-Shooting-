...
| Detailed example vehicle is mistaken for bespoke or drivable final art | High | Register the Epic UE-only source, use it only as static set dressing/cover, disclose it in release notes and retain the final damaged/drivable vehicle art gate |
