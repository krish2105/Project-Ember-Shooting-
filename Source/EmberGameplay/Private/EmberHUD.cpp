...
void AEmberHUD::DrawHUD()
{
    ...
    const bool bHostileTarget = Character && Character->HasHostileUnderCrosshair();
    const FLinearColor CrosshairColor = bHostileTarget
        ? FLinearColor(1.0f, 0.05f, 0.02f, 1.0f)
        : FLinearColor(0.95f, 0.45f, 0.08f, 1.0f);
    ...
    {
        DrawLine(Center.X - 11.0f, Center.Y - 11.0f, Center.X - 4.0f, Center.Y - 4.0f, FLinearColor::White, 2.5f);
        DrawLine(Center.X + 11.0f, Center.Y - 11.0f, Center.X + 4.0f, Center.Y - 4.0f, FLinearColor::White, 2.5f);
        DrawLine(Center.X - 11.0f, Center.Y + 11.0f, Center.X - 4.0f, Center.Y + 4.0f, FLinearColor::White, 2.5f);
        DrawLine(Center.X + 11.0f, Center.Y + 11.0f, Center.X + 4.0f, Center.Y + 4.0f, FLinearColor::White, 2.5f);
    }
